  ...
  _renderHeader() {
    return (
      <View style={{flexDirection: 'column', justifyContent: 'center' ,alignItems: 'center'}}>
        <Text style={{padding: 10, fontSize: 42*minP, textAlign: 'center'}} onPress={this._backButton.bind(this)}>返回</Text>
        <Text style={{padding: 10, fontSize: 42*minP, textAlign: 'center'}} onPress={this._nextButton.bind(this)}>再进入一个Details</Text>
        <Text style={{padding: 10, fontSize: 42*minP, textAlign: 'center'}}>{'欢迎'+this.props.age+'岁的'+this.props.usr+'!'}</Text>
      </View>
    )
  }
